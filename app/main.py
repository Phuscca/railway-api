...
app = FastAPI(title="BDSTT Seller API", version="0.2.1-debug")
...
async def debug_db():
    ...
    async with pool.acquire() as conn:
        ...
        lead_events_count = await conn.fetchval("select count(*) from bdstt_lead_events")
        return {
            "status": "ok",
            "build": "debug-2026-04-14-01",
